...
function ConvertToCAMIOutputLCAFunctionDefault(input_file, taxonomy_file, output_file, hyp_threshes, common_kmer_matrix_normalized, sample_ID, contestant_ID)
...
#		temp[corresponding_real_organism_index] = 0; #set the organism entry to 0. Don't do this.
		...
		if true #distances[pos]<=0.2 #Later, make this adaptable to given input bins
