...
function ConvertToCAMIOutputLCAFunctionSensitive(input_file, taxonomy_file, output_file, hyp_threshes, common_kmer_matrix_normalized, sample_ID, contestant_ID)
